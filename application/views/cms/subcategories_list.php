...
<div class="page-content">
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">	
			<p style="text-align:right"><button type="button" id="add_new" class="btn blue">Add Subcategory Details</button></p>			
						...
						<table class="table table-striped table-bordered table-hover" id="sample_1">
							<thead>
								<tr> 
									...
									<th class="hidden-phone">Subcategories</th>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#add_new").click(function(){
				...
				document.location="<?php echo base_url()?>cms/subcategories/viewCategory";
			});
			...
			$(".btn_delete").click(function(){
				...
				$.post("<?php echo base_url()?>cms/subcategories/deleteCustomization", {
