    <div id="content">
        ...
        <ul class="nav nav-tabs">
          <li class="active"><a href="#custp" data-toggle="tab">Customizable Product</a></li>
          <li><a href="#rtd" data-toggle="tab">Ready To Deliver</a></li>
          <li><a href="#rtp" data-toggle="tab">Ready To Order</a></li>
