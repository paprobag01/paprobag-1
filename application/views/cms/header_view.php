...
<!-- <li <?php if(isset($page) && $page=="dashboard"){?> class="active"<?php }?>>
			    ...
			    <li <?php if(isset($page) && $page=="homepagecontent"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms/homepagecontent">
					<i class="icon-home"></i>Home Page Content
					<span class="selected"></span>
					</a>					
			    </li>
				...
				<li <?php if(isset($page) && $page=="sections"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms/sections">
					<i class="icon-home"></i>Sections
					<span class="selected"></span>
					</a>					
			    </li>
				...
				<li <?php if(isset($page) && $page=="myaccount"){?> class="active"<?php }?>>
			     ...
			     <li <?php if(isset($page) && $page=="orders"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms/orders">
					<i class="icon-home"></i>Orders
					<span class="selected"></span>
					</a>					
			    </li>
			     ...
			     <li <?php if(isset($page) && $page=="testimonials"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms/testimonials">
					<i class="icon-home"></i>Testimonial
					<span class="selected"></span>
					</a>					
			    </li>
			    <li <?php if(isset($page) && $page=="newsletter"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms/newsletter">
					<i class="icon-home"></i>Newsletter Subscriptions
					<span class="selected"></span>
					</a>					
			    </li>
			    
				<li <?php if(isset($page) && $page=="invitefriend"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms/invitefriend">
					<i class="icon-home"></i>Invite Friend
					<span class="selected"></span>
					</a>					
			    </li>
			    <li <?php if(isset($page) && $page=="index1"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms/invitefriend/index1">
					<i class="icon-home"></i>Invite Friend Content
					<span class="selected"></span>
					</a>					
			    </li>
				<li <?php if(isset($page) && $page=="coupan"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms/coupan">
					<i class="icon-home"></i>Create Coupan
					<span class="selected"></span>
					</a>					
			    </li>
