						...
						<div class="tab-content">
							...
							<div class="tab-pane active" id="tab_0">
                              ...
                              <div class="controls">
                                <!-- <textarea  name="details"  id="ai" class="span12 ckeditor m-wrap" cols="30" rows="10">  </textarea> -->
									<select name="cat_id" onchange="getSection(this)" <?php if($type=='view'){?>disabled<?php }?>>
						   ...
						   function getSection(id)
						   {
							...
							xmlhttp.onreadystatechange=function()
							  ...
							  if (xmlhttp.readyState==4 && xmlhttp.status==200)
								...
								alert(data);
								var dt=data.split("|");
								document.getElementById("section_name").value=dt[1];
								document.getElementById("section_id").value=dt[0];
								
								}
							  }
							 xmlhttp.open("POST","<?php echo base_url()?>cms/getSection/section/"+id,true); 
							 xmlhttp.send();
						   }
						   </script>
						    <?php 
						  ...
						  ?>
						    ...
						    <div class="control-group">
                              ...
                              <div class="controls">
                                 <select name="child_cat_id" <?php if($type=='view'){?>disabled<?php }?>>
										<option value="">Select</option>
