		...
		<div class="page-content">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									<thead>
										<tr> 
											...
											<th class="hidden-phone">View Measurements</th>
									...
									<tbody>
										...
										<tr id="<?php echo $row['user_id']?>" class="odd gradeX"> 
											...
											<a href="<?php echo base_url()?>cms/myaccount/getMeasurements/<?php echo $row['user_id']?>/view" class="btn mini purple"><i class="icon-edit"></i> View</a>
											</td>
											<td class="hidden-phone">
			...
			<div id="delete_users" class="modal fade hide">
				...
				<div class="modal-body">
					<p>Do you really want to delete this record.If yes,then click yes to continue.</p> 
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					$(".btn_delete").click(function(){
						...
						$.post("<?php echo base_url()?>cms/myaccount/delete_rec", {
