	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<h3 class="page-title">
					Home Page Content
					<small>Add, Delete, and Home Page</small>
				</h3>
		...
		<div class="row-fluid">
			<div class="span12">	
			<!-- <p style="text-align:right"><button type="button" id="add_new" class="btn blue">Add Home Page</button></p>-->			
						...
						<table class="table table-striped table-bordered table-hover" id="sample_1">
							...
							<tbody>
								...
								<tr id="" class="odd gradeX"> 
									<td><?php echo $cnt;?></td>
									<td class="hidden-phone"><?php echo $row['home_content']?></td>
									
									<td class="hidden-phone">
									
									<a href="<?php echo base_url()?>cms/homepagecontent/add_home_content/<?php echo $row['home_content_id']?>/view" class="btn mini purple"><i class="icon-edit"></i> View</a>&nbsp;&nbsp;&nbsp;
									<a href="<?php echo base_url()?>cms/homepagecontent/add_home_content/<?php echo $row['home_content_id']?>" class="btn mini blue"><i class="icon-edit"></i> Edit</a>&nbsp;&nbsp;&nbsp;
									<a href="<?php echo base_url()?>cms/homepagecontent/deleteHeaderBanner/<?php echo $row['home_content_id']?>" class="btn mini red delete_rec" id="" class="config btn mini red"><i class="icon-trash"></i> Delete</a>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#add_new").click(function(){
				...
				document.location="<?php echo base_url()?>cms/homepagecontent/add_home_content";
			});
