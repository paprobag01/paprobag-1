											   ...
											   url: "<?php echo base_url()?>cms/getSubCategories/filterdropdown",
												...
												success: function(data) 
												{
													var dt=data.split("|");
																...
																if(dt[0]!='<label class="control-label">Category</label><div class="controls"><select name="sub_categories"  id="sub_categories"></select></div>')
																{
																	$('#filters').fadeIn();
																	$('#filters').html(dt[0]);
                                ...
                                <!-- <textarea  name="details"  id="ai" class="span12 ckeditor m-wrap" cols="30" rows="10">  </textarea> -->
									<select name="sec_id" id="sec_id" onchange="getFilters(this.value)" <?php if($type=='view'){?>disabled<?php }?>>
										...
										<?php }?>
											...
											<div class="control-group" id="filters_id" style="display:none;">
