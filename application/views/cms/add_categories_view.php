                        ...
                        <form action="<?php echo base_url()?>cms/categories/save_categories" class="form-horizontal" method="post" enctype="multipart/form-data" />
							...
							<input type="hidden" name="created_on" value="<?php echo date('d-m-Y')?>"/>
							 <div class="control-group">
                              ...
                              <div class="controls">
                                 <select name="section_id" <?php if($type=='view'){?>disabled<?php }?>>
						   ...
						   <div class="control-group">
						    ...
						    <div class="control-group">
                              ...
                              <div class="controls">
								...
								<div class="span2">Parent Category:</div>  <input type="radio" <?php if($type=='view'){?>disabled<?php }?> name="cat_type" id="cat_type" value="1" class="span2  m-wrap" <?php if($cat_type==1){ echo "checked";} ?>/> 
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">                                	
								<div class="span2">Child Category:</div>  <input type="radio" <?php if($type=='view'){?>disabled<?php }?> name="cat_type" id="cat_type" value="2" class="span2  m-wrap" <?php if($cat_type==2){ echo "checked";} ?>/>
                              </div>
                           </div>
						   <div class="control-group">
                              <label class="control-label">&nbsp;</label>
                              <div class="controls">                                	
								<div class="span2">Sub Category:</div>  <input type="radio" <?php if($type=='view'){?>disabled<?php }?> name="cat_type" id="cat_type" value="3" class="span2  m-wrap" <?php if($cat_type==3){ echo "checked";} ?>/>
                              </div>
                           </div>
