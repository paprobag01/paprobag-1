...
<!-- <li <?php if(isset($page) && $page=="dashboard"){?> class="active"<?php }?>>
				...
				<li <?php if(isset($page) && $page=="slider"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms_seller/home">
					<i class="icon-home"></i>Home
					<span class="selected"></span>
					</a>					
			    </li>
				<li <?php if(isset($page) && $page=="slider"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms_seller/SellerList">
			    ...
			    <li <?php if(isset($page) && $page=="homepagecontent"){?> class="active"<?php }?>>
				    <a href="<?php echo base_url()?>index.php/cms_seller/homepagecontent">
