          ...
          <div class="sidebar sidebar_1 " >
            ...
            <div class="side_box side_box_1 red5">
			  ...
			  <?php foreach($sub_category_list as $row){?>
                ...
                <li id="<?php echo $row['section_id']; ?>/<?php echo $row['cat_id']; ?>/<?php echo $row['sub_cat_id']; ?>" onclick="show_filter_subprod(this.id); showsubcat(this.id)"><?php echo $row['sub_cat_name']; ?></li>
			  <?php } ?>
			       </ul>
            </div>
           <form method="post">
