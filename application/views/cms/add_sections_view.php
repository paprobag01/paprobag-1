               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url()?>cms/sections/save_section" class="form-horizontal" method="post" enctype="multipart/form-data" />
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
								  ...
								  <input type="text" <?php if($type=='view'){?>disabled<?php }?> name="section_name" id="section_name" value="<?php echo $section_name?>" class="span4  m-wrap" /> 
                              </div>
                           </div>
